...
export default function Chat() {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      // If this was a new conversation, reload the full history
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <p style={{ color: '#666', margin: '5px 0 0 0' }}>
            Ask me anything about your legal matters, case status, or general legal questions.
          </p>
        </div>
            ...
            messages.map((msg, index) => (
              ...
              >
                <div style={{
                  ...
                  {msg.role === 'assistant' && (
                    <FaRobot size={16} style={{ marginTop: '2px', flexShrink: 0 }} />
                  )}
                  {msg.role === 'user' && (
                    <FaUser size={16} style={{ marginTop: '2px', flexShrink: 0 }} />
                  )}
                  <div>
